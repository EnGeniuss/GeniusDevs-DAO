...
async function main() {
  ...
  const nftContract = await hre.ethers.deployContract("GeniusDevsNFT");
  await nftContract.waitForDeployment();
  console.log("GeniusDevsNFT deployed to:", nftContract.target);
  ...
  const daoContract = await hre.ethers.deployContract("GeniusDevsDAO", [
    fakeNftMarketplaceContract.target,
    nftContract.target,
  ], {value: amount,});
  await daoContract.waitForDeployment();
  console.log("GeniusDevsDAO deployed to:", daoContract.target);
